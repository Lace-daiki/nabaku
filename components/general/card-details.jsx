...
import ProjectsClient from './search/proj-carousel';
...
export default function CardDetails({ project }) {
  ...
  return (
    <div className="w-full min-h-screen bg-white">
      <div className="w-full h-[736px] bg-[#1C1E4C] flex items-center gap-[80px] py-[20px] px-[40px]">
        {/* Project Cover Image with Progress */}
        <div className="relative w-[805px] h-[576px] p-[10px] rounded-[20px] bg-[#FFFFFF]">
          <img
            alt={project.title}
          ...
          <div className="absolute inset-3 flex items-end justify-center">
            <div className="bg-white rounded-[16px] px-4 py-2 shadow-lg flex items-center">
              <div className="w-[578px] h-[6px] bg-gray-200 rounded-full overflow-hidden">
                <div
        ...
        <div className="flex flex-col gap-[384px]">
          <h1 className="text-[48px] font-medium text-[#FFFFFF] mb-2">
            {project.title}
          </h1>
          <button
            onClick={() => setShowDonateModal(true)}
            className="w-full md:w-[492px] h-[44px] border text-[#1C1E4C] hover:text-white px-4 py-2 rounded-[40px] bg-[#FFFFFF] transition-colors cursor-pointer hover:bg-transparent hover:border-white"
          >
            Donate
          </button>
        </div>
      ...
      <div className="pt-[150px] px-[40px] items-center bg-[#FFFFFF] rounded-t-[40px] -mt-8">
        <h2 className='font-medium text-[48px] text-[#1C1E4C] ml-[50px] mb-[30px]'><span className='font-bold italic'>fundraiser</span> information</h2>


        {/* Project Description */}
        <div className="mb-8 w-full h-[416px] bg-[#F3F3F3] py-[96px] px-[64px] rounded-[40px] mb-[180px]">
        ...
        <section className='mb-20'>
          <h2 className='font-medium text-[48px] text-[#1C1E4C] ml-[50px] mb-[30px]'><span className='font-bold italic'>you</span> might be interested in</h2>
          <ProjectsClient />
        </section>
      </div>
      <ContactCard />
