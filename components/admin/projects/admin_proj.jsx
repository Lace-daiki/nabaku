...
export default function AdminCard({ project }) {
  ...
  return (
    <div 
      className="w-[348px] h-[389px] p-[10px] bg-white rounded-lg shadow-md overflow-hidden cursor-pointer hover:shadow-lg transition-shadow duration-300 gap-[10px]"
      onClick={onClick}
    >
      <img
      ...
      />
      <div className="w-full h-[180px] py-[16px] px-[14px] bg-[#EBEEF9] mt-2 rounded-lg shadow-md">
